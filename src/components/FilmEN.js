...
export default function FilmEN() {
  const listItems = api.map(person =>   
    <motion.div whileHover={{scale: 1.1}} className='mt-32 truncate cursor-pointer group' key={person.id}>
              <div>
              <div className="relative overflow-hidden">
              <img className="rounded-lg dark:hover:border-none" width={200} height={100} src={person.poster} />
